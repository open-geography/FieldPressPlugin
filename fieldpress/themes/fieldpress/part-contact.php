...
if ( isset( $_POST['contact_submit_button'] ) ) {
    ...
    if ( $_POST['sender_name'] != '' && $_POST['sender_email'] != '' && $_POST['subject'] != '' && $_POST['message'] ) {
        ...
        if ( is_email( $_POST['sender_email'] ) ) {
            ...
            add_filter( 'wp_mail_from', 'fieldpress_set_sender_from_email' );

            function fieldpress_set_sender_from_email( $email ) {
                return $_POST['sender_email'];
            }

            add_filter( 'wp_mail_from_name', 'fieldpress_set_sender_from_name' );

            function fieldpress_set_sender_from_name( $name ) {
