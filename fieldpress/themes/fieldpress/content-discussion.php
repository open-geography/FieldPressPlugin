    ...
    <header class="entry-header">
        ...
        <div class="discussion-archive-single">
            ...
            <div class="discussion-meta">
                <span><?php echo get_the_date(); ?></span> | <span><?php the_author(); ?></span> | <span><?php echo $discussion->get_stop_name(); ?></span> | <span><?php echo get_comments_number(); ?> <?php _e( 'Comments', 'cp' );?></span>
            </div>
