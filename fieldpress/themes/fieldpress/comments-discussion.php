 ...
 * handled by a callback to fieldpress_comment() which is
...
<div id="comments" class="comments-area discussion-comments">
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <ul class="comment-list">
             ...
             * to use fieldpress_comment() to format the comments.
             * If you want to override this in a child theme, then you can
             * define fieldpress_comment() and that will be used instead.
             * See fieldpress_comment() in inc/template-tags.php for more.
             */
            wp_list_comments( array( 'callback' => 'fieldpress_discussion_comment' ) );
            ?>
        </ul><!-- .comment-list -->
