...
class map_module extends Stop_Module {
	...
	public static function front_main( $data ) {
		$data->name = __CLASS__;
		?>
		<div id="module-<?php echo $data->ID; ?>" class="<?php echo $data->name; ?> front-single-module<?php echo( map_module::FRONT_SAVE == true ? '-save' : '' ); ?>">
	...
	function on_create() {
		...
		$this->description = __( 'Add map block to the stop.', 'cp' );
		$this->label       = __( 'Map', 'cp' );
...
cp_register_module( 'map_module', 'map_module', 'output' );
?>