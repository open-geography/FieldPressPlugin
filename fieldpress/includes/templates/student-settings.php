<?php if ( is_user_logged_in() ) { ?>
	...
	if ( isset( $_POST['student-settings-submit'] ) ) {
		...
		if ( ! isset( $_POST['student_settings_nonce'] ) || ! wp_verify_nonce( $_POST['student_settings_nonce'], 'student_settings_save' )
			...
			do_action( 'fieldpress_before_settings_validation' );
	...
	<?php do_action( 'fieldpress_before_settings_form' ); ?>
	...
	<?php do_action( 'fieldpress_after_settings_first_name' ); ?>
	...
	<?php do_action( 'fieldpress_after_settings_last_name' ); ?>
	...
	<?php do_action( 'fieldpress_after_settings_email' ); ?>
	...
	<?php do_action( 'fieldpress_after_settings_username' ); ?>
	...
	<?php do_action( 'fieldpress_after_settings_passwordon' ); ?>
