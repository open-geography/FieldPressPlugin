...
<div id="poststuff" class="metabox-holder m-settings cp-wrap">
	<form action='' method='post'>
		...
		<div class="postbox">
			...
			<div class="inside">
				...
				<table class="form-table">
					<tbody>
					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_field_slug' id='field_slug' value='<?php echo esc_attr( FieldPress::instance()->get_field_slug() );
							?>'/>&nbsp;/

							<p class='description'><?php _e( 'Your field trip URL will look like: ', 'cp' ); ?><?php echo esc_html( trailingslashit( home_url() ) ); ?><?php echo esc_attr( FieldPress::instance()->get_field_slug() ); ?><?php _e( '/my-field-trip/', 'cp' ); ?></p>
							<hr/>
						</td>
					</tr>

					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Category Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_field_category_slug' id='field_category_slug' value='<?php echo esc_attr( FieldPress::instance()->get_field_category_slug() );
							?>'/>&nbsp;/

							<p class='description'><?php _e( 'Your Field Trip Category URL will look like: ', 'cp' ); ?><?php echo esc_html( trailingslashit( home_url() ) ); ?><?php echo esc_attr( FieldPress::instance()->get_field_slug() ) . '/' . FieldPress::instance()->get_field_category_slug(); ?><?php _e( '/your-category-slug/', 'cp' ); ?></p>
							<hr/>
						</td>
					</tr>

					<!--<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Page', 'cp' ); ?></th>
						<td>
						<?php
					$option_name    = 'fieldpress_field_page';
					$page_shortcode = '[cp_pages page="field"]';
					$pages_args     = array(
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Stops Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() . __( '/my-field-trip/', 'cp' ) ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_stops_slug' id='stops_slug' value='<?php echo esc_attr( FieldPress::instance()->get_stops_slug() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					<!--<tr valign="top">
                            <th scope="row"><?php _e( 'Stops Page', 'cp' ); ?></th>
                            <td>
						<?php
					$option_name    = 'fieldpress_stops_page';
					$page_shortcode = '[cp_pages page="stops"]';
					$pages_args     = array(
						'selected'          => get_option( $option_name, 0 ),
						'echo'              => 1,
						'show_option_none'  => __( 'Use virtual page', 'cp' ),
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Notifications Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() . __( '/my-field-trip/', 'cp' ) ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_notifications_slug' id='notifications_slug' value='<?php echo esc_attr( FieldPress::instance()->get_notifications_slug() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					<!--<tr valign="top">
                            <th scope="row"><?php _e( 'Field Trips Notifications Page', 'cp' ); ?></th>
                            <td>
						<?php
					$option_name    = 'fieldpress_notifications_page';
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Discussions Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() . __( '/my-field-trip/', 'cp' ) ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_discussion_slug' id='discussion_slug' value='<?php echo esc_attr( FieldPress::instance()->get_discussion_slug() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					<!--<tr valign="top">
							<th scope="row"><?php _e( 'Field Trip Discussions Page', 'cp' ); ?></th>
							<td>
						<?php
					$option_name    = 'fieldpress_discussions_page';
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip New Discussions Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() . __( '/my-field-trip/', 'cp' ) ) );
							echo '' . FieldPress::instance()->get_discussion_slug() . '/';
							?>
							&nbsp;<input type='text' name='option_fieldpress_discussion_slug_new' id='discussion_slug_new' value='<?php echo esc_attr( FieldPress::instance()->get_discussion_slug_new() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					<!--<tr valign="top">
							<th scope="row"><?php _e( 'Field Trip New Discussion Page', 'cp' ); ?></th>
							<td>
						<?php
					$option_name    = 'fieldpress_new_discussion_page';
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Grades Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() . __( '/my-field-trip/', 'cp' ) ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_grades_slug' id='grades_slug' value='<?php echo esc_attr( FieldPress::instance()->get_grades_slug() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					<!--<tr valign="top">
							<th scope="row"><?php _e( 'Field Trip Grades Page', 'cp' ); ?></th>
							<td>
						<?php
					$option_name    = 'fieldpress_grades_page';
					...
					<tr valign="top">
						<th scope="row"><?php _e( 'Field Trip Workbook Slug', 'cp' ); ?></th>
						<td>
							<?php
							echo esc_html( trailingslashit( home_url() . __( '/my-field-trip/', 'cp' ) ) );
							?>
							&nbsp;<input type='text' name='option_fieldpress_workbook_slug' id='workbook_slug' value='<?php echo esc_attr( FieldPress::instance()->get_workbook_slug() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					<!--<tr valign="top">
							<th scope="row"><?php _e( 'Field Trip Workbook Page', 'cp' ); ?></th>
							<td>
						<?php
					$option_name    = 'fieldpress_workbook_page';
					...
					<tr valign="top">
						...
						<td>
							<?php
							$option_name    = 'fieldpress_enrollment_process_page';
					...
					<tr valign="top">
						...
						<td>
							<?php
							$option_name    = 'fieldpress_login_page';
					...
					<tr valign="top">
						...
						<td>
							...
							echo esc_html( trailingslashit( home_url() ) );
							?>
							&nbsp;<input type='text' name='option_signup_slug' id='signup_slug' value='<?php echo esc_attr( get_option( 'signup_slug', 'fields-signup' ) );
							?>'/>&nbsp;/
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<?php
							$option_name    = 'fieldpress_signup_page';
					...
					<tr valign="top">
						...
						<td>
							...
							echo esc_html( trailingslashit( home_url() ) );
							?>
							&nbsp;<input type='text' name='option_student_dashboard_slug' id='student_dashboard_slug' value='<?php echo esc_attr( get_option( 'student_dashboard_slug', 'fields-dashboard' ) );
							?>'/>&nbsp;/
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<?php
							$option_name    = 'fieldpress_student_dashboard_page';
					...
					<tr valign="top">
						...
						<td>
							<?php
							$option_name    = 'fieldpress_student_settings_page';
					...
					<tr valign="top">
						...
						<td>
							...
							echo esc_html( trailingslashit( home_url() ) );
							?>
							&nbsp;<input type='text' name='option_instructor_profile_slug' id='instructor_profile_slug' value='<?php echo esc_attr( FieldPress::instance()->get_instructor_profile_slug() );
							?>'/>&nbsp;/
							<hr/>
						</td>
					</tr>
					...
					<?php if ( function_exists( 'messaging_init' ) ) { ?>
						<tr valign="top">
							...
							<td>
								...
								echo esc_html( trailingslashit( home_url() ) );
								?>
								&nbsp;<input type='text' name='option_fieldpress_inbox_slug' id='fieldpress_inbox_slug' value='<?php echo esc_attr( FieldPress::instance()->get_inbox_slug() );
								?>'/>&nbsp;/
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								...
								echo esc_html( trailingslashit( home_url() ) );
								?>
								&nbsp;<input type='text' name='option_fieldpress_sent_messages_slug' id='fieldpress_sent_messages_slug' value='<?php echo esc_attr( FieldPress::instance()->get_sent_messages_slug() );
								?>'/>&nbsp;/
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td>
								...
								echo esc_html( trailingslashit( home_url() ) );
								?>
								&nbsp;<input type='text' name='option_fieldpress_new_message_slug' id='fieldpress_new_message_slug' value='<?php echo esc_attr( FieldPress::instance()->get_new_message_slug() );
								?>'/>&nbsp;/
							</td>
						</tr>
					<?php } ?>
					<!--<tr valign="top">
							...
							<td>
						<?php
					$option_name    = 'fieldpress_instructor_profile_page';
						...
						<td>
							...
							<div class="tooltip">
								...
								<div class="tooltip-content">
									<?php _e( '<div>Attach default FieldPress menu items (Field Trips, Student Dashboard, Log Out ) to the <strong>Primary Menu</strong>.</div><div>Items can also be added from Appearance > Menus and the fieldPress panel.</div>', 'cp' ) ?>
								</div>
							</div>
							...
							if ( current_user_can( 'manage_options' ) ) {
								...
								<span class="add_class_message">
										<?php
										if ( $menu_error ) {
											_e( 'Please add at least one menu and select its theme location in order to show FieldPress menu items automatically.', 'cp' );
										}
										?>
									</span>
							<?php
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'Field Trip Details Page', 'cp' ); ?></span></h3>

			<div class="inside">
				<p class='description'><?php _e( 'Media to use when viewing field trip details', 'cp' ); ?></p>
				<table class="form-table">
					<tbody>
					<tr valign="top">
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'Field Trip Listings', 'cp' ); ?></span></h3>

			<div class="inside">
				<p class='description'><?php _e( 'Media to use when viewing field trip listings (e.g. Field Trips page or Instructor page)', 'cp' ); ?></p>
				<table class="form-table">
					<tbody>
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'Field Trip Images', 'cp' ); ?></span></h3>

			<div class="inside">
				<p class='description'><?php _e( 'Size for ( newly uploaded ) field trip images', 'cp' ); ?></p>
				<table class="form-table">
					<tbody>
					...
					<tr valign="top">
						...
						<td>
							<input type='text' name='option_field_image_width' value="<?php echo esc_attr( get_option( 'field_image_width', 235 ) ); ?>"/>
						</td>
					</tr>
					...
					<tr valign="top">
						...
						<td>
							<input type='text' name='option_field_image_height' value="<?php echo esc_attr( get_option( 'field_image_height', 225 ) ); ?>"/>
						</td>
					</tr>
		...
		<div class="postbox">
			<h3 class="hndle" style='cursor:auto;'><span><?php _e( 'Field Trip Order', 'cp' ); ?></span></h3>

			<div class="inside">
				<p class='description'><?php _e( 'Order of fields in admin and on front. If you choose "Post Order Number", you will have option to reorder field trips from within the field trips admin page.', 'cp' ); ?></p>
				<table class="form-table">
					<tbody>
					...
					<tr valign="top">
						...
						<td>
							<?php $selected_field_order_by = get_option( 'field_order_by', 'post_date' ); ?>
							<select name="option_field_order_by" class="widefat" id="option_field_order_by">
								<option value="post_date" <?php selected( $selected_field_order_by, 'post_date', true ); ?>><?php _e( 'Post Date', 'cp' ); ?></option>
								<option value="field_order" <?php selected( $selected_field_order_by, 'field_order', true ); ?>><?php _e( 'Post Order Number', 'cp' ); ?></option>
							</select>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<?php $selected_field_order_by_type = get_option( 'field_order_by_type', 'DESC' ); ?>
							<select name="option_field_order_by_type" class="widefat" id="option_field_order_by_type">
								<option value="DESC" <?php selected( $selected_field_order_by_type, 'DESC', true ); ?>><?php _e( 'Descending', 'cp' ); ?></option>
								<option value="ASC" <?php selected( $selected_field_order_by_type, 'ASC', true ); ?>><?php _e( 'Ascending', 'cp' ); ?></option>
							</select>
						</td>
					</tr>
		...
		<?php
		do_action( 'fieldpress_general_options_page' );
		?>
